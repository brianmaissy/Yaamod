...
class TestNthAnniversaryOf(TestCase):
    def test_adar_bar_mitzvah_paradox(self):
        ...
        younger_kids_bar_mitzvah = nth_anniversary_of(younger_kids_birthday,
                                                      13)
    ...
    def test_adar_anniversary_in_leap_year(self):
        ...
        self.assertEquals(nth_anniversary_of(original_date, 1),
                          first_anniversary)

    def test_anniversary_of_30_adar_rishon(self):
        original_date = HebrewDate(5746, 12, 30)
        first_anniversary = HebrewDate(5759, 1, 1)
        self.assertEquals(nth_anniversary_of(original_date, 13),
                          first_anniversary)

    def test_anniversary_of_30_cheshvan(self):
        date_of_birth = HebrewDate(5750, 8, 30)
        self.assertEquals(nth_anniversary_of(date_of_birth, 1),
                          HebrewDate(5751, 9, 1))
        self.assertEquals(nth_anniversary_of(date_of_birth, 2),
                          HebrewDate(5752, 8, 30))
...
class TestNextAnniversaryOf(TestCase):
    def test_next_anniversary_invalid_reference_date(self):
        ...
        self.assertEquals(next_anniversary_of(original_date,
                                              original_date + 1),
                          HebrewDate(5751, 8, 1))
    ...
    def test_next_anniversary_is_today(self):
        ...
        self.assertEquals(next_anniversary_of(original_date, reference_date),
                          reference_date)
